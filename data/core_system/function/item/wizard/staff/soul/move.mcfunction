...
# エフェクト
 execute if score @s STV.Wizard.Cool matches 1.. at @s run particle soul_fire_flame ~ ~ ~ 0.4 0.4 0.4 0.03 1 normal
 execute if score @s STV.Wizard.Cool matches 1.. at @s run particle dust{color:[0.1,0.65,1.0],scale:2.0} ~ ~ ~ 0.1 0.1 0.1 0.03 1 normal
