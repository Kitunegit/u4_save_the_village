...
execute at @s as @e[type=#core_system:raid,distance=..4] run damage @s 40 player_attack by @p[tag=Job.Sword]

execute if score @s STV.Ult.Sword.Tick matches 20.. run kill @s