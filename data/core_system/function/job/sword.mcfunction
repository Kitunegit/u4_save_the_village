...
item replace entity @s hotbar.0 with diamond_sword[minecraft:unbreakable={},enchantments={"minecraft:knockback":1,"minecraft:sharpness":4,"minecraft:sweeping_edge":3},item_model=sword]
