...
#
 ...
 execute as @e[tag=Item.Chemist.Potion.Buff.Heal_02.Temporary] unless predicate core_system:is_buff run scoreboard players add @p[tag=Job.Chemist] STV.Common.Ult.Energy 7
