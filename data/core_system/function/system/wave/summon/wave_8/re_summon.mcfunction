...
# 順番に召喚
 function core_system:system/wave/summon/wave_8/1
 schedule function core_system:system/wave/summon/wave_8/2 20t
 schedule function core_system:system/wave/summon/wave_8/3 40t
 schedule function core_system:system/wave/summon/wave_8/4 60t
 schedule function core_system:system/wave/summon/wave_8/5 65t
# 演出
