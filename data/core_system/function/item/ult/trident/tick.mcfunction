...
execute if score @s STV.Ult.Trident.Tick matches 5.. at @s rotated ~ 0 positioned ~ ~-2 ~ positioned ^ ^ ^-3 as @e[type=#core_system:raid,distance=..5] run damage @s 550 player_attack by @p[tag=Job.Trident]
