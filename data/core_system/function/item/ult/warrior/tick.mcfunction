...
execute at @s rotated ~ 0 positioned ~ ~0.5 ~ run particle block_crumble{block_state:dirt} ^ ^ ^4 3 0 3 0 400
execute at @s rotated ~ 0 positioned ~ ~0.5 ~ run particle explosion ^ ^ ^4 3 0 3 0 30
execute at @s as @a[distance=..20] run playsound entity.zombie.break_wooden_door player @s ~ ~ ~ 1 0.75
execute at @s rotated ~ 0 positioned ^ ^ ^10 as @e[distance=..4] run damage @s 50 player_attack by @p[tag=Job.Warrior]
kill @s